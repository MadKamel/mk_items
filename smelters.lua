	...
	if listname == "fuel" then
		if minetest.get_craft_result({method="fuel", width=1, items={stack}}).time ~= 0 then
			if inv:is_empty("src") then
				--meta:set_string("infotext", "Biomass Smelter is Empty.")
			end
...
local function furnace_node_timer(pos, elapsed)
	...
	if cookable then
		...
		if dst_full then
			item_state = "100% (Output Clogged!)"
		else
			item_state = item_percent.."%"
		end
	else
		if srclist and not srclist[1]:is_empty() then
			item_state = "Not Smeltable."
		else
			item_state = "Empty"
		end
	end
	...
	if fuel_totaltime ~= 0 then
		...
		swap_node(pos, "mk_items:biomass_smelter_active")
		...
		swap_node(pos, "mk_items:biomass_smelter")
	...
	local infotext
	if active then
		infotext = "Configure Inactive Biomass Smelter"
	else
		infotext = "Configure Working Biomass Smelter"
	end
...
minetest.register_node("mk_items:biomass_smelter", {
	description = "Biomass Smelter",
	tiles = {
	...
	on_blast = function(pos)
		...
		drops[#drops+1] = "mk_items:biomass_smelter"
...
minetest.register_node("mk_items:biomass_smelter_active", {
	description = "Active Biomass Smelter",
	tiles = {
		"default_furnace_top.png", "default_furnace_bottom.png",
		"default_furnace_side.png", "default_furnace_side.png",
